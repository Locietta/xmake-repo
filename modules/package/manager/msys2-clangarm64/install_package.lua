...
import("package.manager.msys2.install_package", {alias = "msys2_install_package"})
...
function main(name, opt)
    opt = table.join(opt or {}, {manager_name = "msys2-clangarm64"})
    return msys2_install_package(name, opt)
end
